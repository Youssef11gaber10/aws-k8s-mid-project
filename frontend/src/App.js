...
const API_URL= ('/api') // will return to origin that called it from browser , it will be ALB then ingress , in ingress /api/* -> http://flask-svc:5000/api/* -> http://flask-svc:5000/api/tasks
function App() {
  ...
  const fetchTasks = async () => {
    ...
    try {
      ...
      setTasks(Array.isArray(response.data) ? response.data : []); // to test docker file locally 
      setError(null);
    } catch (error) {
